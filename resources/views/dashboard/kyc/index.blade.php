                    ...
                    <div class="row mb-2">
                        <div class="col-md-6">
                            <div class="page-title-box">
                                <h1 class="page-title text-dark">KYC Management</h1>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-3">
                            <div class="card stats-card border-left-success">
                                <div class="card-body">
                                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">All Users</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{$tierCounts['all_users']}}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="card stats-card border-left-primary">
                                <div class="card-body">
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Tier 1 Users</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $tierCounts['tier_1'] }}</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card stats-card border-left-warning">
                                <div class="card-body">
                                    <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Tier 2 Users</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $tierCounts['tier_2'] }}</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card stats-card border-left-success">
                                <div class="card-body">
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Tier 3 Users</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $tierCounts['tier_3'] }}</div>
                                </div>
                            </div>
                        </div>
                            ...
                            <table id="sms-datatable" class="table table-hover dt-responsive nowrap w-100 table-centered mb-0">
                                ...
                                @foreach($usersWithKyc as $user)
                                    <tr class="border-bottom">
                                        ...
                                        <td class="align-middle py-3">
                                            <span class="text-dark fw-medium">{{ ucfirst($user->kyc->tier ?? 'N/A') }}</span>
                                        </td>
                                        <td class="align-middle py-3">
                                            <span class="text-dark fw-medium">{{ strtoupper($user->kyc_type ?? 'none') }}</span>
                                        </td>
                                        <td class="align-middle py-3">
