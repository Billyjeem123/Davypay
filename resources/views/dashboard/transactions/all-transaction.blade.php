                    ...
                    <div class="row mb-2">
                        <div class="col-md-6">
                            <div class="page-title-box">
                                <h1 class="page-title text-dark">Transaction Report</h1>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="card stats-card border-left-warning">
                                <div class="card-body">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ number_format($pending_count) }}</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card stats-card border-left-danger">
                                <div class="card-body">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ number_format($failed_count) }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
