            ...
            <td class="content">
                ...
                <p class="message">
                    Hello {{ $transaction->user->first_name ?? 'there' }},<br><br>
                     ...
                     Your transfer of   ₦{{ number_format($data['data']['transaction']['transactionAmount'] ?? 0, 2) }} to {{ number_format($data['data']['customer']['recipientName'] ?? 'recipient' }}  has been refunded .<br><br>

                    The full amount of   ₦{{ number_format($data['data']['transaction']['transactionAmount'] ?? 0, 2) }} has been credited back to your wallet.
                </p>
